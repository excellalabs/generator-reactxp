...
module.exports = class extends CopyTemplateGenerator {
  constructor(args, opts) {
    ...
    this.location = path.join(this.options.rootDir, 'containers', this.options.componentName)
  }

  checkExistance () {
    if (fs.existsSync(this.location)) {
      return Promise.reject(`Error: Container ${this.options.componentName} already exists!`)
    }
  }
